...
```{r partition_training, message=FALSE}
...
The in sample error was `r inSample_Error` and the confusion matrix with the train data was 


```{r cm_test, message=FALSE}
...
The out of sample error was `r OutSample_Error` and the confusion matrix with the test data was 
```{r cm_train, message=FALSE}
...
```{r Validation_cleaning_prediction, message=FALSE}
